...
public class TC185_Verify_Paypal_Payment_Is_Not_Configurable_With_Invalid_Details extends BaseTest {
...
//		logInfo("Username entered as "+data.get("username")+" and Password entered as "+data.get("password"));
		...
		Invalidaccountdetailspage Invalidaccount = SetupPayPalPage.invalidErrorPage(data.get("payPalAPIUsername"), data.get("payPalAPIPassword"), data.get("payPalAPISignature"));
	}

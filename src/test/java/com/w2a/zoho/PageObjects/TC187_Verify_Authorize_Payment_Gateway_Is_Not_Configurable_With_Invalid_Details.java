...
//import com.w2a.zoho.PageObjects.AuthorizeMerchanLogin;
...
//
//public class TC187_Verify_Authorize_Payment_Gateway_Is_Not_Configurable_With_Invalid_Details extends BaseTest {
//
//	
//	String TCID= "TC187";
//	
...
//		Invalidaccountdetailspage Invalid = SetupAuthorizePage.invalidErrorpage(data.get("authorizeAPIUsername"), data.get("authorizeAPIPassword"), data.get("authorizeAPISignature"));
//		Invalid.goToPaymentGatewayPage();
//
//		

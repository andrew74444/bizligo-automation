...
public class TC074_Community_Admin_Group_Join_Request_Reject_Email_Notification_To_Member extends BaseTest {
	String TCID ="TC074";
	...
	public void EmailVerification(Hashtable<String,String> data) throws Exception {
		...
		gmail.emailNotification("Your Request to Join Private Group is not Approved");

...
public class TC079_Member_Cancel_Private_Community_From_Global_Communities_Email_Notification_To_Member  extends BaseTest {
	String TCID ="TC079";
	...
	public void EmailVerification(Hashtable<String,String> data) throws Exception {
		...
		gmail.Login(data.get("email10"), data.get("password3"));

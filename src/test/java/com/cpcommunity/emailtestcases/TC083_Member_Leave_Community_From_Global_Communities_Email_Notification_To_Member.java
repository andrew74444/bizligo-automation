...
public class TC083_Member_Leave_Community_From_Global_Communities_Email_Notification_To_Member extends BaseTest {
	String TCID ="TC083";
	...
	public void EmailVerification(Hashtable<String,String> data) throws Exception {
		...
		gmail.Login(data.get("email11"), data.get("password3"));

...
public class TC055_Make_Admin_To_Group_By_Community_Admin_Email_Notification_To_Member  extends BaseTest {
	String TCID ="TC055";
	...
	public void EmailVerification(Hashtable<String,String> data) throws Exception {
		...
		gmail.emailNotification("You are Group Admin now");

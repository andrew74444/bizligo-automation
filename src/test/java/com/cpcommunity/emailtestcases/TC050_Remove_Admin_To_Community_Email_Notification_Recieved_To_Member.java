...
public class TC050_Remove_Admin_To_Community_Email_Notification_Recieved_To_Member extends BaseTest {
	...
	public void EmailVerification(Hashtable<String,String> data) throws Exception {
		...
		gmail.emailNotification("You are removed as Community Admin");

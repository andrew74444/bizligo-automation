...
public class TC078_Member_Join_Private_Community_From_Global_Communities_Email_Notification_To_Member extends BaseTest {
	String TCID ="TC078";
	...
	public void EmailVerification(Hashtable<String,String> data) throws Exception {
		...
		gmail.emailNotification("Your Request to Join Private Community");

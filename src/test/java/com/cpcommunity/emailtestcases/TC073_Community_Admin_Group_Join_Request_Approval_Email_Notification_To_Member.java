...
public class TC073_Community_Admin_Group_Join_Request_Approval_Email_Notification_To_Member extends BaseTest {
	String TCID ="TC073";
	...
	public void EmailVerification(Hashtable<String,String> data) throws Exception {
		...
		gmail.emailNotification("Your Request to Join Private Group is Approved");

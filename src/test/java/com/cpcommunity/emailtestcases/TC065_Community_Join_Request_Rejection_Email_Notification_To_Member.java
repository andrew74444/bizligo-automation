...
public class TC065_Community_Join_Request_Rejection_Email_Notification_To_Member extends BaseTest {
	String TCID ="TC065";
	...
	public void EmailVerification(Hashtable<String,String> data) throws Exception {
		...
		gmail.Login(data.get("email8"), data.get("password3"));
		gmail.emailNotification("Your Request to Join Private Community is not Approved");

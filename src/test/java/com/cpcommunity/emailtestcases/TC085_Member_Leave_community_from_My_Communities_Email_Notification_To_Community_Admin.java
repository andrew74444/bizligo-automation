...
public class TC085_Member_Leave_community_from_My_Communities_Email_Notification_To_Community_Admin extends BaseTest {
	String TCID ="TC085";
	...
	public void EmailVerification(Hashtable<String,String> data) throws Exception {
		...
		gmail.emailNotification("Member Left from the Community");

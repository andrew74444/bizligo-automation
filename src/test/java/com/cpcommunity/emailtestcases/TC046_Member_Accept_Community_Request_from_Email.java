...
public class TC046_Member_Accept_Community_Request_from_Email extends BaseTest {
	...
	public void EmailVerification(Hashtable<String,String> data) throws Exception {
		...
		JoinUserCommunity JoinUserCommunity = login_Page.joinUserCommunityLogin(data.get("email3"),data.get("password1"));
		JoinUserCommunity.successfullyJoinCommunity(TCID);

...
public class TC085_Member_Leave_community_from_My_Communities_Email_Notification_To_Member extends BaseTest {
	...
	public void EmailVerification(Hashtable<String,String> data) throws Exception {
		...
		gmail.Login(data.get("email5"), data.get("password3"));

...
public class TC046_Member_Already_Joined_Community extends BaseTest {
	...
	public void EmailVerification(Hashtable<String,String> data) throws Exception {
		...
		gmail.Login(data.get("email13"), data.get("password3"));
		gmail.emailNotification("Community join invitation");
		LoginPage login_Page = gmail.joinCommunity();
		JoinUserCommunity JoinUserCommunity = login_Page.joinUserCommunityLogin(data.get("email"),data.get("password1"));
		JoinUserCommunity.alreadyMember(TCID);

...
public class TC057_Remove_Member_To_Group_By_Community_Admin_Email_Notification_To_Member extends BaseTest {
	String TCID ="TC057";
	...
	public void EmailVerification(Hashtable<String,String> data) throws Exception {
		...
		gmail.emailNotification("You have been removed from Group");

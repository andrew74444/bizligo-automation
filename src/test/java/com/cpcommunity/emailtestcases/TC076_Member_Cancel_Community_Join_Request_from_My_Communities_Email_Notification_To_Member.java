...
public class TC076_Member_Cancel_Community_Join_Request_from_My_Communities_Email_Notification_To_Member extends BaseTest {
	String TCID ="TC076";
	...
	public void EmailVerification(Hashtable<String,String> data) throws Exception {
		...
		gmail.Login(data.get("email9"), data.get("password3"));
		gmail.emailNotification("You are successfully left from the community");

...
public class TC054_Add_Member_To_Group_By_Community_Admin_Email_Notification_To_Member extends BaseTest {
	...
	public void EmailVerification(Hashtable<String,String> data) throws Exception {
		...
		gmail.emailNotification("You have been added to Group");

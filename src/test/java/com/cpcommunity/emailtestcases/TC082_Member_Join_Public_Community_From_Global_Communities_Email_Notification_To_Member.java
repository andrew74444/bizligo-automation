...
public class TC082_Member_Join_Public_Community_From_Global_Communities_Email_Notification_To_Member extends BaseTest {
	String TCID ="TC082";
	...
	public void EmailVerification(Hashtable<String,String> data) throws Exception {
		...
		gmail.emailNotification("You have Successfully Joined Community");

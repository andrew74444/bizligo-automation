...
public class TC1177_verify_if_EventName_changed_Displaying_inCommunityPage extends BaseTest{
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC1177(Hashtable<String,String> data) throws Exception {
		//
	
	ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
	DataUtil.checkExecution("master", "TC1177", data.get("Runmode"), excel);
	...
	managewidget.RenameEventsWidget(data.get("events"));
	...
	communitywidget.RenameEventsWidget(data.get("events1"));

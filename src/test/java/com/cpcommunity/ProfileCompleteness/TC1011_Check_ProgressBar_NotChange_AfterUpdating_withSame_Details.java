...
public class TC1011_Check_ProgressBar_NotChange_AfterUpdating_withSame_Details extends BaseTest {
	
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC1011(Hashtable<String,String> data) throws Exception {
 
		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		DataUtil.checkExecution("master", "TC1011", data.get("Runmode"), excel);
		...
		Assert.assertEquals(prevProgress, afterProgress);
}

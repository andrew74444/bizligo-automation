...
public class TC2190_Verify_receiver_not_able_edit_connection_notes extends BaseTest{
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC2190(Hashtable<String,String> data) throws Exception {

		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		DataUtil.checkExecution("master", "TC2190", data.get("Runmode"), excel);
		...
		MDP1.checkConnectionMsgIsEditable(data.get("Notes"));

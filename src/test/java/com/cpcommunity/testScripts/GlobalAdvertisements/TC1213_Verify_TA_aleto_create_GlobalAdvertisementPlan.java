...
public class TC1213_Verify_TA_aleto_create_GlobalAdvertisementPlan extends BaseTest{
	...
	MAPP.createAdByTA(data.get("name"),data.get("name1"),data.get("price"),data.get("price1"), data.get("planDetails"),data.get("duration"),data.get("duration1"),data.get("durationType"),data.get("adLocation"),data.get("adType"), data.get("approvalType"));
	MAPP.inactivatePlanTA(data.get("plan"));

...
public class TC1235_verify_properErrormsg_display_onClicking_Cancel_after_filling_Details extends BaseTest{
	...
	MAPP.CreateAndCancelAdByTA(data.get("name"),data.get("price"), data.get("planDetails"),data.get("duration"),data.get("durationType"),data.get("adLocation"),data.get("adType"), data.get("approvalType"));
	}
	@AfterMethod
	public void tearDown() {
		
		logInfo("TC1235 Test Completed");

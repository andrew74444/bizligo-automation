...
public class TC205_Tenant_Admin_Create_Community2 extends BaseTest {
	...
	public void TC205(Hashtable<String,String> data) throws Exception {
		...
		plansPage.CreatePlan(PlanName, PlanPrice, PlanDuration, NumberOfAdmins, NumberOfGroups, NumberOfMembers);  

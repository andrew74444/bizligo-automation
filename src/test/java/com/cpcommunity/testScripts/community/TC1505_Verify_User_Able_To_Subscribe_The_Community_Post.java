...
public class TC1505_Verify_User_Able_To_Subscribe_The_Community_Post extends BaseTest

{

@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
public void TC1505(Hashtable<String,String> data) throws Throwable {

ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
DataUtil.checkExecution("master", "TC1505", data.get("Runmode"), excel);
...
// Discussions.SubscribeCommunitydiscussion();
communityDetails.SubscribeCommunitydiscussion();
}

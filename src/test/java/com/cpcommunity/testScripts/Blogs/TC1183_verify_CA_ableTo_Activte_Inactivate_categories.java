...
//	CommunityDashboardPage CDP=blogpage.gotoCommunityDashboard();
	blogpage.gotoMyEcoSystem();
	 mycommunities = EcoSystemPage.goToMyCommunities();
	 communityDashboard = mycommunities.gotoManageCommunity(data.get("communityName"));
	 
	CategoriesPage categories1=communityDashboard.gotoCategories();

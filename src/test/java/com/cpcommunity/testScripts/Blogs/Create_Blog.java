...
public class Create_Blog extends BaseTest {
	...
	public void TC194(Hashtable<String,String> data) throws Throwable
	{
		...
		communityBlogsPage.createBlog(data.get("title"),data.get("shortDescription"),data.get("content"));
		CommunityDetailsPage communityDetailsPage = communityDashboardPage.navigateToCommunityDetailsPage(data.get("communityName"));
		EcoSystemPage = EcoSystemPage.goToMyEcosystem();
		BlogsPage bolgsPage = EcoSystemPage.goToBlogsPage();
		bolgsPage.searchPost(data);

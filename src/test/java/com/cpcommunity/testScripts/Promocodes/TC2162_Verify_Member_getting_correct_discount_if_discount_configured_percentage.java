...
public class TC2162_Verify_Member_getting_correct_discount_if_discount_configured_percentage extends BaseTest{
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC2162(Hashtable<String,String> data) throws Exception {

	ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
	DataUtil.checkExecution("master", "TC2162", data.get("Runmode"), excel);

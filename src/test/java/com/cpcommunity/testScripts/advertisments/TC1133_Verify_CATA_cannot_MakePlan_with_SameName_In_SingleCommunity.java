...
public class TC1133_Verify_CATA_cannot_MakePlan_with_SameName_In_SingleCommunity extends BaseTest{
	...
	MAPP.createAdPlanwithsameName(data.get("name"),data.get("price"), data.get("planDetails"),data.get("duration"),data.get("durationType"),data.get("adLocation"),data.get("adType"), data.get("approvalType"));
	
	}
	@AfterMethod
	public void tearDown() {
		
		logInfo("TC1133 Test Completed");

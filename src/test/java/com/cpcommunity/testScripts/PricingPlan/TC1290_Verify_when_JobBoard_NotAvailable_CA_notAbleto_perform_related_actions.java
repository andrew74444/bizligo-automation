...
public class TC1290_Verify_when_JobBoard_NotAvailable_CA_notAbleto_perform_related_actions extends BaseTest {
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC1290(Hashtable<String,String> data) throws Exception {
 
		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		DataUtil.checkExecution("master", "TC1290", data.get("Runmode"), excel);

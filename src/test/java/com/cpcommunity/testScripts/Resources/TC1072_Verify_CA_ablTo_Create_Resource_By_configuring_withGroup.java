...
public class TC1072_Verify_CA_ablTo_Create_Resource_By_configuring_withGroup extends BaseTest{
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC1072(Hashtable<String,String> data) throws Exception {
 
		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		DataUtil.checkExecution("master", "TC1072", data.get("Runmode"), excel);
		...
		manageres.AddFields(data.get("Title"),data.get("Title1"),data.get("Group"), data.get("Description"),data.get("url"));
		manageres.checkResouces();
	}
	@AfterMethod
	public void tearDown() {
		
		logInfo("TC1072 Test Completed");

...
public class TC1244_verify_DynamicMenu_displaying_inBizligosite_after_Bizligo_creatd extends BaseTest {
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC1244(Hashtable<String,String> data) throws Exception {
		
	
	ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
	DataUtil.checkExecution("master", "TC1244", data.get("Runmode"), excel);

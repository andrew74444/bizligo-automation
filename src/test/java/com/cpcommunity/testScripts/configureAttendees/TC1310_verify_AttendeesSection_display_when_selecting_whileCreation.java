...
public class TC1310_verify_AttendeesSection_display_when_selecting_whileCreation extends BaseTest{
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC1310(Hashtable<String,String> data) throws Exception {
 
		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		DataUtil.checkExecution("master", "TC1310", data.get("Runmode"), excel);
	...
	event.AttendeesDetailDisplaying();
}
	@AfterMethod
	public void tearDown() {

		logInfo("TC1310 Test Completed");

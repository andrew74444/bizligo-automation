...
public class TC1311_verify_InviteGuest_NotDisplaying_ifNotSelected_while_creating extends BaseTest {
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC1311(Hashtable<String,String> data) throws Exception {
 
		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		DataUtil.checkExecution("master", "TC1311", data.get("Runmode"), excel);

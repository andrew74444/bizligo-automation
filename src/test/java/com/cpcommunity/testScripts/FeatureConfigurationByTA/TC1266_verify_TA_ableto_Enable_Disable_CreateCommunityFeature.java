...
public class TC1266_verify_TA_ableto_Enable_Disable_CreateCommunityFeature extends BaseTest {
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC1266(Hashtable<String,String> data) throws Exception {
		
	
	ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
	DataUtil.checkExecution("master", "TC1266", data.get("Runmode"), excel);
   ...
   FC.clickfeature(data.get("feature"));
   FC.enableFeature(data.get("feature"));
	
	}
	@AfterMethod
	public void tearDown() {
		
		logInfo("TC1266 Test Completed");

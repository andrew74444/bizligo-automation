...
public class TC1104_Verify_EmaolHeader_FromEmail_EmailSubject_Mandatory_inET extends BaseTest{
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC1104(Hashtable<String,String> data) throws Exception {
		
	ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
	DataUtil.checkExecution("master", "TC1104", data.get("Runmode"), excel);
...
//	MyCommunitiesPage myCommunity = login.loginToMyCommunitiesPage(data.get("email"), data.get("password"));
	...
	emailtemplate.RequiredFieldValidity( data.get("Subject"),data.get("Header"), data.get("Email"));

}
	@AfterMethod
	public void tearDown() {
		
		logInfo("TC1104 Test Completed");

...
public class TC3010_Verify_Tenant_Admin_can_Able_To_Pending_Testimonail  extends BaseTest
{
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC3010(Hashtable<String,String> data) throws Exception {

		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		DataUtil.checkExecution("master", "TC3010", data.get("Runmode"), excel);
		...
		Edit.pendingTestimonial(data.get("notes"));
	
		Yahoo yahoo= new Yahoo().open();
		yahoo.Login(data.get("email2"), data.get("password2"));
		yahoo.testimonialsPending();

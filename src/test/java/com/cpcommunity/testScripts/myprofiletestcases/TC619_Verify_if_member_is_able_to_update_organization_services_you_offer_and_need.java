...
public class TC619_Verify_if_member_is_able_to_update_organization_services_you_offer_and_need extends BaseTest {

	
	
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC619(Hashtable<String,String> data) throws Throwable {

		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		DataUtil.checkExecution("master", "TC619", data.get("Runmode"), excel);

...
public class TC312_Verify_Whether_member_is_able_to_add_organization_services_you_offer_and_need extends BaseTest {

	
	
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC312(Hashtable<String,String> data) throws Throwable {

		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		DataUtil.checkExecution("master", "TC312", data.get("Runmode"), excel);

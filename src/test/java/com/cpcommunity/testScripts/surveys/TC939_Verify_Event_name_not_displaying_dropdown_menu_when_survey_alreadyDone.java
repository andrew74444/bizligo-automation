...
public class TC939_Verify_Event_name_not_displaying_dropdown_menu_when_survey_alreadyDone extends BaseTest{
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC939(Hashtable<String,String> data) throws Exception {

		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		DataUtil.checkExecution("master", "TC939", data.get("Runmode"), excel);
		...
		SP.eventNameNotVisibleInDropDown(data.get("Title"));

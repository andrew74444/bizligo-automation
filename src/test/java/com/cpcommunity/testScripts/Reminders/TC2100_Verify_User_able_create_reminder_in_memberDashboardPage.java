...
public class TC2100_Verify_User_able_create_reminder_in_memberDashboardPage extends BaseTest{
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC2100(Hashtable<String,String> data) throws Exception {

		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		DataUtil.checkExecution("master", "TC2100", data.get("Runmode"), excel);
		...
		RP.addNewReminder(data.get("Title"));

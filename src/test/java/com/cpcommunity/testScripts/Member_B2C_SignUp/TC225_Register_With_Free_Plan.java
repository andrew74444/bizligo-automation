...
public class TC225_Register_With_Free_Plan extends BaseTest {

	PaymentReceipt PaymentReceipt;
	
	@Test(dataProviderClass = DataProviders.class, dataProvider = "masterDP")
	public void TC225(Hashtable<String, String> data) throws Exception {

		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		DataUtil.checkExecution("master", "TC225", data.get("Runmode"), excel);
		log.info("Inside TC225 Test");
		log.info(data);		
...
//		AccountSelectPlansPage accountSelectPlansPage = new AccountSelectPlansPage().open("");
		int price =accountSelectPlansPage.selectPlan(planFeatures.get("planName"));

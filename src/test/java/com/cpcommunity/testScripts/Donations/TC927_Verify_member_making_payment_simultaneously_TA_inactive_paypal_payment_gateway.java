...
public class TC927_Verify_member_making_payment_simultaneously_TA_inactive_paypal_payment_gateway extends BaseTest{
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC927(Hashtable<String,String> data) throws Exception {

		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		DataUtil.checkExecution("master", "TC927", data.get("Runmode"), excel);
        ...
        BCP1.checkPaypalGatewayWhenInactivate();

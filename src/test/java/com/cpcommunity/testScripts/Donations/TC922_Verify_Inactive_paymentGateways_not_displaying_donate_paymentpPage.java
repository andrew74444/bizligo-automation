...
public class TC922_Verify_Inactive_paymentGateways_not_displaying_donate_paymentpPage extends BaseTest {
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC922(Hashtable<String,String> data) throws Exception {

		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		DataUtil.checkExecution("master", "TC922", data.get("Runmode"), excel);

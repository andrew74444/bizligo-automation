...
public class TC915_Verify_DonationsMenu_notDisplaying_TA_dashboardPage_SuperAdmin_disabled_donations extends BaseTest{
	@Test(dataProviderClass=DataProviders.class,dataProvider="masterDP")
	public void TC915(Hashtable<String,String> data) throws Throwable {


		
		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		DataUtil.checkExecution("master", "TC915", data.get("Runmode"), excel);

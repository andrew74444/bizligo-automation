...
// */
//public class TC013_Veirfy_Rejected_Endorsment_Displayed_In_Member_Profile extends TestBase{
//	private final Logger log = LoggerHelper.getLogger(TC013_Veirfy_Rejected_Endorsment_Displayed_In_Member_Profile.class);
//	
//	String TCID="TC013";
...
//		return data;			
//	}
//	@Test(dataProvider="testData",description= "Rejeceted Endorsment is not displayed in the memeber profile",enabled=true,groups="Rejeceted_Endorsment_is_not_displayed")
//	public void Verify_Rejeceted_Endorsment_is_not_displayed_in_the_memeber_profile(String LoginEMailID, String Password,String MemberName,String EndormentMessage,String runMode) throws Exception{
...
//		status = Profile_Page.IsEndoremsnetNotDisplayed(EndormentMessage+"1");
//		AssertionHelper.updateTestStatus(status);
//	}
//}

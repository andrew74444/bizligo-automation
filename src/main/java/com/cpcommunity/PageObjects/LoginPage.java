...
//	public MyDashboardPage loginToApplication(String enterEmailAddress, String password) {
...
//	public PendingCommunitiesPage SystemAdminloginToRejctCommunity(String enterEmailAddress, String password) {
//		this.login(enterEmailAddress, password);
...
//	public JoinUserCommunity joinUserCommunityLogin(String enterEmailAddress, String password) {
//
//		this.login(enterEmailAddress, password);
//		return (JoinUserCommunity) openPage(JoinUserCommunity.class);

...
//				.findElement(By.xpath("//*[contains(text(),'Showing 1 to " + T1 + " of " + T1 + " entries')]"));
...
//		waitHelper.waitForElement(ele, expTime);
	...
	public String selectMembershipPlan(int ID) {
		...
		if (ID < 4) {
			click(driver.findElement(By.xpath("(//input[@type='checkbox'])[2]")), "Selecting the Advertisements Feature");
...
//	}
	...
	public void checkPurchasedMembershipPlanIsNotEditable() throws Exception {
		...
		waitForElementToPresent(editMembershipPlan);
		click(editMembershipPlan,"edit MembershipPlan");

...
public class PayPalPayment extends BasePage{
...
//	public String PayPalMerchantLogin(String PEmail, String PPwd,String PaidAmountInPayPalGateway ) throws Exception{
//		
...
//			System.out.println(PaidAmountInPayPalGateway);
//			System.out.println(AmountPaid);
//			if(PaidAmountInPayPalGateway.equals(AmountPaid)) 
//			{					
//				break;
//			}		
//			else 
...
//	}
	...
	public PaymentConfirmation payPalconfirmation() {
...
//					{
					//System.out.println(list.get(i).getText());
					Amount = driver.findElement(By.xpath("//*[@class='css-19a55ol ejutlyo5']")).getText();

...
public class ExcelReader {
	...
	public boolean setCellData1(String sheetName, String colName, int rowNum, String value) {
		try {
			int col_Num = -1;
	...
	public void setData(int rowNumber, int colNumber, String data) throws Exception {
		// "D:\\Workspace\\SampleProject\\src\\test\\resources\\testdata\\master
		// (Recovered).xlsx"
		...
		// "TestCases"
		XSSFSheet sh1 = wb.getSheet(Constants.Sheet2);
	...
	public static void main(String arg[]) throws IOException, InvalidFormatException {
		...
		org.apache.poi.ss.usermodel.Workbook workbook = WorkbookFactory.create(fi);
	...
	//
	// String n = "C:\\Users\\SasiVinodAkula\\Downloads\\i2i_repayment.xlsx";
	// FileInputStream filea = new FileInputStream(n);
	//
	// XSSFWorkbook wba =new XSSFWorkbook(filea);
	//
	// XSSFSheet sha = wba.getSheet("Sheet1");
	//
	// sha.getRow(3).createCell(8).setCellValue("Sasi");
	//
	// FileOutputStream fouta = new FileOutputStream(n);
	//
	// wba.write(fouta);
	//
	//
